# Model card — `calibrated_linear_svc-20260825-120-v3`
...
| Trained at | 2026-08-25T12:08:02+00:00 |
| Git SHA | `7acabdbf200e3616661ede3e011ddc6e527ea133` |
| Dataset snapshot | `20260825-120-v3` |
...
| Macro-F1 | 0.671 |
| Accuracy | 0.758 |
| Coverage after abstention | 89.9% |
| Accuracy on the articles it files | 0.809 |
| Inference | 0.057 ms/article |
| Bundle size | 11.7 MB |
| Training articles | 3,003 |
...
| `disaster_accident` | 90 | 43 | 0.84 | 0.00 | 0.84 | yes |
| `politics` | 504 | 182 | 0.83 | 0.00 | 0.80 | yes |
| `education` | 232 | 14 | 0.79 | 0.44 | 0.83 | yes |
| `crime_justice` | 221 | 51 | 0.74 | 0.33 | 0.80 | yes |
| `technology` | 346 | 41 | 0.74 | 0.00 | 0.80 | yes |
| `entertainment_arts` | 315 | 33 | 0.70 | 0.47 | 0.81 | yes |
| `science_space` | 157 | 23 | 0.61 | 0.48 | 0.82 | yes |
| `health` | 256 | 23 | 0.55 | 0.49 | 0.85 | yes |
| `conflict_war` | 61 | 21 | 0.47 | 0.38 | 0.60 | **no** |
| `environment_climate` | 93 | 16 | 0.40 | 0.45 | 0.50 | **no** |
| `society_lifestyle` | 185 | 40 | 0.30 | 0.33 | 0.64 | **no** |
