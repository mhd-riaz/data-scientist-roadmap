# Model card — `calibrated_linear_svc-20260826-120`
...
| Trained at | 2026-08-26T10:31:41+00:00 |
| Git SHA | `4b507c376566cf15ee409c3fd6faec26275c506d` |
| Dataset snapshot | `20260826-120` |
| Corpus cut | 2026-08-26T10:29:53+00:00 |
...
| Macro-F1 | 0.720 |
| Accuracy | 0.753 |
| Coverage after abstention | 82.9% |
| Accuracy on the articles it files | 0.832 |
| Inference | 0.059 ms/article |
| Bundle size | 20.4 MB |
| Training articles | 5,525 |
...
| --- | --- | --- | --- | --- | --- | --- |
| `sport` | 532 | 94 | 0.94 | 0.00 | 0.92 | yes |
| `entertainment_arts` | 532 | 114 | 0.83 | 0.00 | 0.85 | yes |
| `business_economy` | 584 | 174 | 0.81 | 0.00 | 0.87 | yes |
| `crime_justice` | 493 | 104 | 0.80 | 0.35 | 0.80 | yes |
| `disaster_accident` | 274 | 68 | 0.79 | 0.34 | 0.80 | yes |
| `politics` | 1085 | 229 | 0.76 | 0.45 | 0.80 | yes |
| `science_space` | 235 | 64 | 0.75 | 0.28 | 0.80 | yes |
| `technology` | 449 | 70 | 0.71 | 0.51 | 0.80 | yes |
| `education` | 349 | 29 | 0.68 | 0.52 | 0.81 | yes |
| `conflict_war` | 122 | 56 | 0.67 | 0.00 | 0.84 | yes |
| `health` | 381 | 54 | 0.62 | 0.56 | 0.81 | yes |
| `environment_climate` | 183 | 53 | 0.58 | 0.70 | 0.82 | yes |
| `society_lifestyle` | 306 | 67 | 0.42 | — | — | **forced abstain** |

Target precision was 80%. Classes that never reach it at
any cut: none. Those are not thresholds that need tuning — they are
